(function (angular, config) {
  ...
  function directive($window, $timeout, trinketConfig) {
    ...
    return {
      restrict: 'E',
      scope: true,
      templateUrl: '/cache-prefix-cf84dfb2/partials/directives/trinket.html',
      link: link
    };
  }
  ...
  angular.module('trinket.search', ['trinket.components.trinkets']).directive('trinketSearch', [
    ...
    function ($document, trinketsApi) {
      ...
      return {
        restrict: 'E',
        templateUrl: '/cache-prefix-cf84dfb2/partials/directives/trinket-search.html',
        link: link,
        scope: {
          placeholderText: '@',
          onSelect: '=',
  ...
  'foldersApi',
  'trinketShare',
  function ($scope, $document, $state, $stateParams, config, trinketsApi, libraryState, $timeout, $interval, $filter, $window, $q, roles, trinketGroups, foldersApi, trinketShare) {
